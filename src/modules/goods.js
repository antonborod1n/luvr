//like btn
const goodsBtnLike = document.querySelector('.goods__btn-like');

goodsBtnLike.addEventListener('click', function () {
    goodsBtnLike.classList.toggle('goods__btn-like--active');
});
